            ...
            <div class='content'>
                <div class="square-item" v-for='item in squareActive'>
                    <div class="square-item-userinfo-wrapper">
                        <img class='user-head-img' :src="item.userHeadUrl"  alt="">
                        <div class="square-item-username">{{item.userName}}</div>
...
<script>
    ...
    export default{
        ...
        created(){
            var thisVm = this;
            getSquareActive().then( function( res ){ thisVm.squareActive = res.data  })
        },
    }
</script>
