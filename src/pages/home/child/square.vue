            ...
            <div class='content'>
                <div class="square-item" v-for='item in squareActive'>
                    ...
                    <div class="square-contentText-wrapper">
                        ...
                        <div class='dongtai-time'>{{item.meta.creatAt}}</div>
                    </div>
...
<style lang="scss"> 
     ...
     /*广场样式*/
     $userinfo-item-height: 4.5rem;
     $user-head-img-width: 4rem;
    ...
    .square-icon-wrapper, .dongtai-time{
        float: right;
    }
    .dongtai-time{
        height: $userinfo-item-height / 1.5; 
        line-height: $userinfo-item-height / 1.5; 
        color: #666;
        font-size: 15px;
    }
    .xin{
    ...
    .icon{
        height: $userinfo-item-height / 1.5;
        width: $userinfo-item-height / 1.5;
    }
