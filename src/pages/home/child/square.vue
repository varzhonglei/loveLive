...
<script>
    ...
    import { getSquareActive } from '../../../getData/getData.js'
    export default{
        data(){
            return{
                squareActive: {},
...
<style scoped lang="scss">
    ...
    .icon{
        height: $userinfo-item-height /4;
        width: $userinfo-item-height /4;
    }
