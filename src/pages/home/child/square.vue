            ...
            <div class='content'>
                <div class="square-item" v-for='item in squareActive'>
                    ...
                    <div class='reply-content-wrapper' v-for='innerItem in item.reply'>
                        <div v-if='innerItem.from._id == getOwnId || (innerItem.to ? innerItem.to._id : "") == getOwnId'
                    ...
                    <div class="reply-input-wrapper" v-if='!replyWho && replyDongTaiId === item._id'>  
                        ...
                        <div class="send-reply-wrapper" @click='sendDongTaiReply(item._id, item.whoPublish._id, $event)'>
                            <button>评论</button>
                        </div>
                    </div>
                </div>
